...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    alert('New Password and Confirm Password do not match!');
        ...
        $check_sql = "SELECT * FROM admin WHERE Password='$CurrentPass'";
                        ...
                        <div class="container mt-5">
                            ...
                            <div class="card shadow-lg mt-4">
                                <div class="card-header bg-light">
                                    <h4 class="text-secondary">Reset Your Password :</h4>
                                </div>
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <label class="form-label mt-3">Conferm Password</label>
                                        <input type="password" class="form-control" name="Conpass" required>



                                        <button type="submit" class="btn btn-info text-white w-100 mt-4">Change</button>
                                    </form>
                                </div>
                            </div>
                        </div>

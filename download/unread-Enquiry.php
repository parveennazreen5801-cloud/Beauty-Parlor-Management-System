            ...
            <div class="container-fluid" id="cards-container">
                <div class="row m-0 p-0 mt-5">
                    ...
                    <div class="col-sm-8 mt-5 bg-dark text-light">
                        <u>
                            <h1 class="text-center fw-bold ">UnRead Enquiry</h1>
                        </u>
                ...
                <td>" . $row['Email'] . "</td>
                <td>" . $row['Date'] . "</td>
                <td><span class='fs-4'>Deleted</span></td>
                </tr>";

                                }
                            } else {
                                echo "<tr><td colspan='7' class='text-center'>No unread Enquiry</td></tr>";
                            }

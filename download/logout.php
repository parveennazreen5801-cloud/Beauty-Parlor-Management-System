...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">  <!-- container-fluid to span full width -->
      <a class="navbar-brand text-light" href="#">BPMS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link text-light" href="#">Admin</a></li>
          <li class="nav-item"><a class="nav-link text-light" href="#">Signup</a></li>

  ...
  <div class="page-wrapper d-flex" style="min-height:100vh;">
    ...
    <div class="sidebar bg-light p-3" id="sidebar" style="width:250px;">
      <ul class="nav flex-column px-2 mt-5 gap-4">
        ...
        <li class="nav-item"> <a href="#" class="nav-link d-flex justify-content-between align-items-center"> <span><i
                class="fa fa-calendar-check me-2"></i>Appointment</span> <i class="fa fa-angle-left"></i> </a>
          <ul class="submenu">
      ...
      <div class="container-fluid" id="cards-container">
        <div class="row m-0 p-0 mt-5">
          ...
          <div class="col-sm-8 mt-5 bg-dark text-light">
            <u>
              <h1 class="text-center fw-bold ">Read Enquiry</h1>
            </u>
...
if (isset($_POST['delete'])) {
  ...
  // Step 1: Get data from enquiry before deleting
  $getData = "SELECT * FROM enquiry WHERE S_No = $S_No";
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    $insert = "INSERT INTO unreadenquiry (Name, Email, Date) VALUES ('$Name', '$Email', '$Date')";
    mysqli_query($con, $insert);

    
    $delete = "DELETE FROM enquiry WHERE S_No = $S_No";
    $res = mysqli_query($con, $delete);

    if ($res) {
      echo "<script>alert('Moved to Unread Enquiry Successfully'); window.location.href=window.location.href;</script>";
    } else {

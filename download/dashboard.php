      ...
      <div class="container-fluid" id="cards-container">
        <div class="row g-3 mt-5">
          <div class="col-12 col-md-6 col-lg-4 mt-5">
            <div class="card-box purple ">
              <h6>Total</h6>
              <a href="customer-List.php" class="txt">
                <h4>Customer</h4>
              </a>
              <p><?php
          ...
          <div class="col-12 col-md-6 col-lg-4 mt-5">
            <div class="card-box darkgray">
              <h6>Total</h6>
              <a href="all-Appointment.php" class="txt">
                <h4>Appointment</h4>
              </a>
              <p><?php
              $sql = "Select * from appoinment";
          ...
          <div class="col-12 col-md-6 col-lg-4 mt-5">
            <div class="card-box orange">
              <h6>Total</h6>
              <a href="accept-Appointment.php" class="txt">
                <h4> Accept Appointment</h4>
              </a>
              <p><?php
              $sql = "Select * from accept_appointment";
              $res = mysqli_query($con, $sql);
              echo mysqli_num_rows($res)
                ?></p>
            </div>
        ...
        <div class="row g-3 mt-2">
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card-box purple ">
              <h6>Total</h6>
              <a href="reject-Appointment.php" class="txt">
                <h4> Reject Appointment</h4>
              </a>
              <p><?php
              $sql = "Select * from reject_appointment";
              $res = mysqli_query($con, $sql);
              echo mysqli_num_rows($res)
                ?></p>
            </div>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card-box darkgray">
              <h6>Total</h6>
              <a href="read-Enquiry.php" class="txt">
                <h4> Enquiry</h4>
              </a>
              <p><?php
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card-box orange">
              <h6>Total</h6>
              <a href="add-Service.php" class="txt">
                <h4> Services</h4>
              </a>
              <p><?php

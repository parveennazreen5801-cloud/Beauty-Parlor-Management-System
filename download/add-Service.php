...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql="INSERT INTO `cart01` ( `P_img`, `Title`, `Dis`, `Price`) VALUES ( '$img', '$name', '$Dis', '$price');";
    ...
    <div class="page-wrapper d-flex" style="min-height:100vh;">
        ...
        <div class="sidebar bg-light p-3" id="sidebar" style="width:250px;">
            <ul class="nav flex-column px-2 mt-5 gap-4">
                ...
                <li class="nav-item"> <a href="#" class="nav-link d-flex justify-content-between align-items-center">
                        <span><i class="fa fa-calendar-check me-2"></i>Appointment</span> <i
            ...
            <div class="container-fluid" id="cards-container">
                <div class="row g-3 mt-5">
                    <div class="col-sm-12 mt-5">
                        <div>
                            <h1 style="color:#E94E02;font-size:32px">Add services</h1>
                        </div>
                    ...
                    <form  method="post" enctype="multipart/form-data" class="borderd-shadow shadow-lg p-4 rounded">
                         <div class="mt-4">
                            <h4 style="color:#6F6F6F;background-color:#EAEAEA" class="ps-4 py-3">Parlour Services:</h4>
                        </div>
                        <label class="form-label">Service Name</label>
                        <input type="text" class="form-control"  name="name">

                        <label class="form-label">Service Desciption</label>
                        ...
                        <button type="submit"class="form-control  mt-3 " style="background-color:#5ACAE3;color:white">Add</button>
                    </form>
                    </div>
                </div>
